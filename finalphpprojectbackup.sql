...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2023 at 06:27 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `try` ()  SQL SECURITY INVOKER SELECT al.ass_id, a.assignment_name, a.subject,a.description,s.fname, s.lname
FROM assignment_list al
...
(111, 'Make This', 'Math', 'Try this at home', 4),
(112, 'a', 'a', 'a', 4),
(113, 'Make This', 'English', 'Do this at home', 4),
(114, 'Solve for X', 'Math', 'Find the value of X', 4),
(115, 'Solve for X', 'Math', 'Find the value of X', 4);
...
--
ALTER TABLE `assignment_list`
  MODIFY `ass_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=323;

--
-- AUTO_INCREMENT for table `student`
--
ALTER TABLE `student`
  MODIFY `student_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
